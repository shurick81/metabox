node("metabox") {
    ...
    try {
        ...
        try {
            mbUtils.runMetaboxVagrantStackVMUp(mbSrcPath,      "regression-win2016::vs13");
            mbUtils.runMetaboxVagrantStackVMDestroy(mbSrcPath, "regression-win2016::vs13");

            mbUtils.runMetaboxVagrantStackVMUp(mbSrcPath,      "regression-win2016::vs15");
            mbUtils.runMetaboxVagrantStackVMDestroy(mbSrcPath, "regression-win2016::vs15");
