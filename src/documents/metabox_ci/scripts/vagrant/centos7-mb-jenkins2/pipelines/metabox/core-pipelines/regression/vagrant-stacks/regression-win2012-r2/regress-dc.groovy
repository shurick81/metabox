node("metabox") {
    ...
    try {
        ...
        try {
            mbUtils.runMetaboxVagrantStackVMUp(mbSrcPath,      "regression-win2012-r2::client");
            mbUtils.runMetaboxVagrantStackVMDestroy(mbSrcPath, "regression-win2012-r2::client");
        } finally {
            mbUtils.runMetaboxVagrantStackVMDestroy(mbSrcPath, "regression-win2012-r2::client");
        }
