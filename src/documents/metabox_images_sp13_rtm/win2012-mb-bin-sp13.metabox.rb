MetaboxResource.define_config("win2012-mb-bin-sp13") do | metabox |
  ...
  metabox.define_packer_build("win2012-mb-bin-sp13") do | packer_build |

    packer_build.packer_file_name = "win2012-mb-bin-sp13.json"
    packer_build.vagrant_box_name = "win2012-mb-bin-sp13-#{git_branch}"
    ...
    packer_build.define_packer_template do | packer_template |
      ...
      3.times do
        packer_template.provisioners << { 
          ...
          "environment_vars" => [
            ...
            "METABOX_PREREQ_DIR=#{sp_prereq_dir}"
          ]
        }
        packer_template.provisioners << { 
      ...
      packer_template.provisioners << { 
        ...
        "inline" => [
          ...
          "Remove-Item '#{sp_prereq_dir}\\*' -Recurse -Force -ErrorAction SilentlyContinue"
        ]
      }
      packer_template.provisioners << { 
        "type" => "windows-restart"
      ...
      packer_template.post_processors << {
        ...
        "Properties" => {
          "output": "#{working_dir}/packer_boxes/win2012-mb-bin-sp13-#{git_branch}-{{.Provider}}.box"
        }
      }
