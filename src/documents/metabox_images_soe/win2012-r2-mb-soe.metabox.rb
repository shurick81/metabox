...
MetaboxResource.define_config("win2012-r2-mb-soe") do | metabox |
  ...
  metabox.description = "Builds Windows 2012R2 SOE image"

  metabox.define_packer_build("win2012-r2-mb-soe") do | packer_build |

    packer_build.packer_file_name = "win2012-r2-mb-soe.json"
    packer_build.vagrant_box_name = "win2012-r2-mb-soe-#{git_branch}"
    ...
    packer_build.define_packer_template do | packer_template |
      ...
      packer_template.builders << {
        ...
        "Properties" => {
          ...
          "builder" => {
            output_directory: "#{working_dir}/packer_output/win2012-r2-mb-soe-#{git_branch}"
          }
        }
      }
      ...
      packer_template.post_processors << {
        ...
        "Properties" => {
          "output": "#{working_dir}/packer_boxes/win2012-r2-mb-soe-#{git_branch}-{{.Provider}}.box"
        }
      }
