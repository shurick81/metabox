node("metabox") {
    ...
    try {
        ...
        try {
            ...
            mbUtils.runMetaboxVagrantStackVMDestroy(mbSrcPath, "regression-win2012-r2::sql12");

            mbUtils.runMetaboxVagrantStackVMUp(mbSrcPath,      "regression-win2012-r2::sql14");
            mbUtils.runMetaboxVagrantStackVMDestroy(mbSrcPath, "regression-win2012-r2::sql14");

            mbUtils.runMetaboxVagrantStackVMUp(mbSrcPath,      "regression-win2012-r2::sql16");
            mbUtils.runMetaboxVagrantStackVMDestroy(mbSrcPath, "regression-win2012-r2::sql16");
        } finally {
