MetaboxResource.define_config("regression-win2012-r2") do | metabox |
  ...
  dc_domain_full_name  = "reg-win2012-r2.local"

  metabox.define_vagrant_stack("regression-win2012") do | vagrant_stack |
